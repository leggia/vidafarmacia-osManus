...
import {
  ...
  Plus,
  Sparkles,
  HeartHandshake, Megaphone, Landmark, Wallet2, LineChart, ShieldAlert, ShieldCheck, Pill, Contact , ClipboardList , Inbox , ScanLine , BookOpen } from "lucide-react";
...
const menuItems = [
  ...
  { icon: BookOpen, label: "Kardex", path: "/kardex" },
